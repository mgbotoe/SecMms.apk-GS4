...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/mime4j/util/CharsetUtil$1;,
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 787
    const-class v5, Lorg/mime4j/util/CharsetUtil;

    invoke-static {v5}, Lorg/apache/commons/logging/LogFactory;->getLog(Ljava/lang/Class;)Lorg/apache/commons/logging/Log;

    move-result-object v5

    sput-object v5, Lorg/mime4j/util/CharsetUtil;->log:Lorg/apache/commons/logging/Log;

    .line 806
    const/16 v5, 0x93

    new-array v5, v5, [Lorg/mime4j/util/CharsetUtil$Charset;

    const/4 v6, 0x0

    new-instance v7, Lorg/mime4j/util/CharsetUtil$Charset;
    ...
    invoke-direct {v7, v8, v9, v10, v11}, Lorg/mime4j/util/CharsetUtil$Charset;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lorg/mime4j/util/CharsetUtil$1;)V
    ...
    sput-object v5, Lorg/mime4j/util/CharsetUtil;->JAVA_CHARSETS:[Lorg/mime4j/util/CharsetUtil$Charset;

    .line 999
    const/4 v5, 0x0

    sput-object v5, Lorg/mime4j/util/CharsetUtil;->decodingSupported:Ljava/util/TreeSet;

    .line 1005
    const/4 v5, 0x0

    sput-object v5, Lorg/mime4j/util/CharsetUtil;->encodingSupported:Ljava/util/TreeSet;

    .line 1011
    const/4 v5, 0x0

    sput-object v5, Lorg/mime4j/util/CharsetUtil;->charsetMap:Ljava/util/HashMap;
    ...
    .local v2, i:I
    :goto_0
    sget-object v5, Lorg/mime4j/util/CharsetUtil;->JAVA_CHARSETS:[Lorg/mime4j/util/CharsetUtil$Charset;
    ...
    #getter for: Lorg/mime4j/util/CharsetUtil$Charset;->canonical:Ljava/lang/String;
    invoke-static {v5}, Lorg/mime4j/util/CharsetUtil$Charset;->access$100(Lorg/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    sget-object v5, Lorg/mime4j/util/CharsetUtil;->decodingSupported:Ljava/util/TreeSet;

    sget-object v6, Lorg/mime4j/util/CharsetUtil;->JAVA_CHARSETS:[Lorg/mime4j/util/CharsetUtil$Charset;

    aget-object v6, v6, v2

    #getter for: Lorg/mime4j/util/CharsetUtil$Charset;->canonical:Ljava/lang/String;
    invoke-static {v6}, Lorg/mime4j/util/CharsetUtil$Charset;->access$100(Lorg/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    .line 1026
    sget-object v5, Lorg/mime4j/util/CharsetUtil;->encodingSupported:Ljava/util/TreeSet;
    ...
    sget-object v5, Lorg/mime4j/util/CharsetUtil;->charsetMap:Ljava/util/HashMap;

    #getter for: Lorg/mime4j/util/CharsetUtil$Charset;->canonical:Ljava/lang/String;
    invoke-static {v0}, Lorg/mime4j/util/CharsetUtil$Charset;->access$100(Lorg/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    .line 1036
    #getter for: Lorg/mime4j/util/CharsetUtil$Charset;->mime:Ljava/lang/String;
    invoke-static {v0}, Lorg/mime4j/util/CharsetUtil$Charset;->access$200(Lorg/mime4j/util/CharsetUtil$Charset;)Ljava/lang/String;
    ...
    .line 1039
    :cond_1
    #getter for: Lorg/mime4j/util/CharsetUtil$Charset;->aliases:[Ljava/lang/String;
    invoke-static {v0}, Lorg/mime4j/util/CharsetUtil$Charset;->access$300(Lorg/mime4j/util/CharsetUtil$Charset;)[Ljava/lang/String;
    ...
    .line 1046
    .end local v0           #c:Lorg/mime4j/util/CharsetUtil$Charset;
    :cond_3
    sget-object v5, Lorg/mime4j/util/CharsetUtil;->log:Lorg/apache/commons/logging/Log;
    ...
    sget-object v7, Lorg/mime4j/util/CharsetUtil;->decodingSupported:Ljava/util/TreeSet;
    ...
    sget-object v7, Lorg/mime4j/util/CharsetUtil;->encodingSupported:Ljava/util/TreeSet;
